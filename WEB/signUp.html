    ...
    <div class="container-fluid">
        <div class="row">
            <h1 class="col-md-12 text-center" text-center style="background-color:#DFDFDF;">会員情報入力</h1>
                ...
                <input type="text" class="form-control p-12" id="address" placeholder="">
                ...
                <input type="text" class="form-control mt-2" id="name2" placeholder="ナマエ">

                <label for="phonenumber" class="form-label col-md-12 mt-2" style="background-color:#DFDFDF;">電話番号</label>
                <input type="text" class="form-control" id="phonenumber" placeholder="000-0000-0000">

                <label for="Gender" class="col-form-label col-md-12 mt-2" style="background-color:#DFDFDF;">性別</label>
                <div class="col-12">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="Gender1" value="男性">
                    <label class="form-check-label" for="男性">男性</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="Gender2" value="女性">
          ...
          <button class="btn btn-danger"  type="button">新規登録をする</button>
          </div>
        </div>
      </div>
