        ...
        <div class="container-fluid">
            <div class="row">
              ...
              <div class="d-grid gap-2 mt-3">
                  <button class="btn text-white" type="submit" onclick="registClick" style="background-color:#68C5F3;">新規登録をする</button>

                  <a href="http://bold-obi-8187.littlestar.jp/TICKEPATH/www/logIn.php">
