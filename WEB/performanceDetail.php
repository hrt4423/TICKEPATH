...
<div class="container-fluid">   
    ...
    <form action="performanceDetail.php" method="post">
	<button type="submit" class="btn btn-outline-danger" name="favbtn">
    ...
    <!-- <form action="performanceDetail.php" method="post">
    <button type="submit" name="favbtn">登録</button>
    </form> -->
    
    <?php
        if(isset($_POST['favbtn'])){
            $daoFavorite->insertFavoriteArtist($clientId, $artistId);
        }
    ?>
