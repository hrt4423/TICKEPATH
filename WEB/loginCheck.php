<?php
    ...
    */
    ...
    switch ($err_flg) {
        case 1:
            $err_msg = '<p class="card-title text-center mt-4">入力されたメールアドレスのアカウントは存在しません</p>';
            break;
        case 2:
            $err_msg = '<p class="card-title text-center mt-4">パスワードが一致しません</p>';
            break;
        case 3:
            $err_msg = '<p class="card-title text-center mt-4">不正な形式のメールアドレスです</p>';
            break;
        default:
            break;
    }
            ...
            <div class="card border-dark mt-1">
                ...
                '</h5>
                    ...
                    <div class="offset-lg-4 col-lg-4  offset-sm-4 col-sm-4  mt-2">
                        ...
                        <button class="btn-sm mb-2 btn text-white border-dark" style="background-color:#64BCFC;" onclick=transition()>
                            ログイン画面に戻る
                        </button>
                        </div>
                    </div>
